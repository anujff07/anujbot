...
API_ID = int(environ.get('API_ID', '29121976'))
API_HASH = environ.get('API_HASH', '9e4744cc10e4581189ebc6d3de3f9a9d')
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5863036646').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002131499711').split()]
...
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002131499711')
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None
NO_RESULTS_MSG = bool(environ.get("NO_RESULTS_MSG", False))

# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://anujff07:anuj276122@cluster0.xqaii0v.mongodb.net/?retryWrites=true&w=majority")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002131499711'))
...
URL = "https://demo-jrl7.onrender.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://demo-jrl7.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://demo-jrl7.onrender.com/".format(FQDN)
else:
    URL = "https://demo-jrl7.onrender.com/".format(FQDN)
